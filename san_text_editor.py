...
main_application.title('SAN Text Editor')
...
count = 0
for i in color_dict:
    color_theme.add_radiobutton(label=i, variable=theme_choice, compound=tk.LEFT)
    count += 1
